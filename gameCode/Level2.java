...
/**
 * the level 2 gameCanvas of the game.
 *
 * @author class3
 */
public class Level2 extends LevelCanvas {
     ...
     */
    public Level2(boolean mode) throws IOException {
        ...
        startThread();
        System.out.println("is running of level2   " + isRunning);
    ...
    public void finishLevel() {
        ...
        Level3 level3 = midlet.getLevel3();
        midlet.switchDisplayable(null, level3);
    ...
    public void init() throws IOException {
        ...
        try {
            ...
            mpStart = new MyMediaPlayer("/Sound/Level2.mp3");
        ...
        try {
            img_office1 = Image.createImage("/Pics/office2.png");
        ...
        try {
            ...
            startImg1 = Image.createImage("/Pics/level2Start1.png");
            startImg2 = Image.createImage("/Pics/level2Start2.png");
        } catch (IOException ex) {
            ex.printStackTrace();
        }
        ...
        boss = new Boss1(gd.getBoss_2(), gd, elv.getX() - 900, gd.Boss2WalkSeq, gd.Boss2AttackSeq);
        boss.setIsFalling(true);

        boss.setHealth(boss.getHealth() + (boss.getHealth() / 2));
     ...
     */
    public void run() {
        System.out.println("now this shit" + isRunning);
